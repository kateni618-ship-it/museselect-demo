import { forUCollections, getProduct, products, selectedCreator } from "../data/mock-data.js";
      ...
      <section class="for-u-page">
        <header class="creator-home-header">
          ...
          <div>
            ...
            <h1>For ${selectedCreator.name}'s <span>Style</span></h1>
          </div>
        ...
        <section class="creator-section">
          <div class="static-topic-title">The Hype List</div>
