...
export const videoJobs = [
  {
    id: "video-outfit-rotation",
    title: "Wedding Guest Outfit Rotation",
    lookIds: ["look-rose-story", "look-wedding-edit"],
    template: "Outfit Rotation",
    duration: "10s",
    status: "Generating",
    progress: "46%",
    thumbnailProductId: "rose-noir-mini"
  },
  {
    id: "video-story-reel",
    title: "Rose Mini Story Reel",
    lookIds: ["look-rose-story"],
    template: "Story Reel",
    duration: "5s",
    status: "Ready",
    progress: "100%",
...
export const rewardOrders = [
  ...
  },
  {
    ...
    productId: "botanical-resort-midi",
    date: "Jun 9, 2026",
    rewardTask: "monthlyBoost",
    rewardMonth: "2026-06",
    rewardStatus: "estimate",
    orderStatus: "Purchased",
    gmv: 78
  },
  {
